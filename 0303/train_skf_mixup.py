...
def train(data_dir, model_dir, args):
    ...
    #         scheduler = MultiStepLR(optimizer, (30, 69))
        ...
        for epoch in range(args.epochs):
            ...
            for idx, train_batch in enumerate(train_loader):
                ...
                matches += (lam * preds.eq(targets_a).sum().item() + (1 - lam) * preds.eq(targets_b).sum().item())
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default=os.environ.get('SM_CHANNEL_TRAIN', '/opt/ml/input/data/train/images_modify'))
